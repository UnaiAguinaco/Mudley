...
public class UserRegistrationDto {
	...
	public UserRegistrationDto(String name, String email, String password, String image, float budget, String country,
			String city, int cv, String link, String description, String genderId, boolean artista, boolean organizacion) {
		super();
		this.name = name;
		this.email = email;
